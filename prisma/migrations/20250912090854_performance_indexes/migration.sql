...
CREATE INDEX IF NOT EXISTS idx_followup_logs_invoice_sent 
...
CREATE INDEX IF NOT EXISTS idx_invoices_company_amount
...
CREATE INDEX IF NOT EXISTS idx_followup_logs_sequence_step
...
CREATE INDEX IF NOT EXISTS idx_companies_trn
ON companies(trn) WHERE trn IS NOT NULL;

-- 13. Email tracking performance for follow-up analysis
CREATE INDEX IF NOT EXISTS idx_followup_logs_email_opened
...
CREATE INDEX IF NOT EXISTS idx_invoices_complex_dashboard
...
CREATE INDEX IF NOT EXISTS idx_followup_logs_automation
